function cropLines(text, el) {

const container = el.closest(".typelighter_box");
    ...
    while (ghost.offsetHeight > container.clientHeight) {

        const range = document.createRange();
        const node = ghost.firstChild;
...
display = display.substring(cut + 1);
...
function e(a,b){this.i=b;this.speed=parseInt(a.getAttribute("data-speed"),10)||1;this.h=parseInt(a.getAttribute("data-start"),10)||500;this.endDelay=parseInt(a.getAttribute("data-end"),10)||2E3;this.l="false"!==a.getAttribute("data-random");this.g=parseFloat(a.getAttribute("data-max"))||!1;this.j="false"!==a.getAttribute("data-dltSpeed");this.f=a;this.b=0;this.text="";this.c=!1;this.a=function(){};

"true"==a.getAttribute("data-checkVisible")?f(this):this.loop()}
e.prototype.loop=function(){var a=this;if(!(this.g&&this.b>this.g)){if(0!==this.b){var b=this.i[Math.floor(this.b-.5)%this.i.length];this.text=b.substring(0,this.text.length+(this.c?-1:1));
  
  
  var display = this.c
    ? this.text
    : cropLines(this.text, this.f);


this.f.innerHTML =
'<span class="wrap">'+display+"</span>";""===this.text&&this.c?(this.c=!1,this.b+=.5,b=this.h):

this.text!==b||this.c?b=this.c&&this.j?1/this.speed:this.l?(200-10*Math.random())/this.speed:100/this.speed:(b=this.endDelay,this.text=display,this.c=!0,this.b+=.5)}


else b=this.h,this.b+=.5;setTimeout(function(){return a.loop()},
b)}};
